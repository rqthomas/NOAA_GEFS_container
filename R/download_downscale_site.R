...
##' @return None
##'
##' @param site_index, full path to 6hr file
##' @param lat_list, full path to 1hr file that will be generated
##' @param lon_list, full path to 1hr file that will be generated
##' @param overwrite, logical stating to overwrite any existing output_file
##' @param model_name, logical stating to overwrite any existing output_file
##' @param model_name_ds, logical stating to overwrite any existing output_file
##' @param output_directory, logical stating to overwrite any existing output_file
##' @export
##' 
##' @author Quinn Thomas
##' 
